...
//TODO: team 10158 program structure*********for Marcus/Oliver/Dominic/Eduardo***************
//  public class TwoPersonDriveTeleOp extends LinearOpMode
//      define field variables
//          ***public PIDFController liftPIDF;
//      public TwoPersonDriveTeleOp(boolean setAuto) {autonomous = setAuto;}
...
//      public void runOpMode() {work();} ***work() has all the method to run the robot during TELEOP
//      public void work() {
//          while (!isStarted() && !isStopRequested()) {}
//          initialize();
//          frameTimer.resetTimer();
//          leftIntakeArm.getController().pwmEnable();          NEED to research this method to learn more
//          rightIntakeArm.getController().pwmEnable();
//          while (opModeIsActive()) {
//              driverControlUpdate();                          SEE BELOW---contain action of all gamepad buttons
//              telemetry();                                    SEE BELOW---display status of all hardware states
//          }
//      }
//              public void telemetry() {
//                      telemetryA.addData("Intake State", intakeState);...}   DISPLAY STATUS AT ALL TIME
//              public void driverControlUpdate() {
//                      updateFrameTime();drive();buttonControls();teleopLiftControlUpdate(); updateServoMechanisms();fineAdjustControls()}
//    *
//    NEXT METHOD FOR AUTONOMOUS USE
//          public void autonomousControlUpdate() {updateFrameTime(); updateLift(); updateServoMechanisms();}
//    *
//    NEXT METHODS FOR TELEOP BUTTONS
//    public void drive() {Mecanum wheel drive method...}
...
//        // intake presets
//        if (gamepad1.circle || gamepad1.b) {intakeReset.run();} else {intakeReset.reset();}
//        if (gamepad1.a || gamepad1.cross) {intakeOut.run();} else {intakeOut.reset();}
//        if (gamepad1.right_stick_button) {intakeArmMoveUpOnePixel.run();} else {intakeArmMoveUpOnePixel.reset();}
//     ....}
//    *
//    NEXT METHODS FOR FUNCTION/ACTION/METHOD
...
//            leftLift.setPower(-gamepad2.left_stick_y); rightLift.setPower(-gamepad2.left_stick_y); liftManualControlReset.reset();
//        } else {liftManualControlReset.run(); updateLift();}}
//     public void updateServoMechanisms() {updateTransfer();updateIntake();updateOuttake();...}
//     public void updateIntakeClawPixelAdjust() {}
//     public void setTransferState(int state) {
//              switch (state) {
//              case TRANSFER_IDLE:....case TRANSFER_PRESET_HOLD:
//                transferState = state;...break;}
//              updateTransfer();}
...
//      public void setLiftTargetPosition(int position) {liftTargetPosition = position; liftPIDF.reset(); updateLift();}
//     } end everything
...
@TeleOp(name = "FTC1058 Two Person Drive", group = "Drive")
public class TwoPersonDriveTeleOp extends LinearOpMode {
    ...
    public TwoPersonDriveTeleOp() {
    }

    public TwoPersonDriveTeleOp(boolean setAuto) {
        autonomous = setAuto;
    }
...
//        rightLift = hardwareMap.get(DcMotorEx.class, "rightLift");
        ...
        leftFront.setDirection(DcMotorSimple.Direction.REVERSE);        //TODO: does match with our RoadRunner
        leftRear.setDirection(DcMotorSimple.Direction.REVERSE);         //TODO: does match with our RoadRunner
...
//    }
    ...
    public void work() {
        ...
        frameTimer.resetTimer();
//        leftIntakeArm.getController().pwmEnable();            //TODO: research this method to learn more
//        rightIntakeArm.getController().pwmEnable();
...
//            telemetry();                                      //TODO: see method below
        }
    }

//TODO: Marcus/Oliver/Alejandro/Dominic:  research this method to learn more
//
//    public void telemetry() {
...
//    }
    ...
    public void driverControlUpdate() {
//        updateFrameTime();                          //TODO: see method below--line 1109, what is it for?

        drive();

//        buttonControls();                         //TODO: See method below

//        teleopLiftControlUpdate();                //TODO: See method below

//        updateServoMechanisms();                  //TODO: See method below

//        fineAdjustControls();                     //TODO: See method below
    }

    public void autonomousControlUpdate() {
//        updateFrameTime();                        //TODO: See method below--what is it use for, line 1109

//        updateLift();                             //TODO: See method below
...
//TODO: Marcus/Oliver/Alejandro/Dominic:  research this method to learn more--BUTTON COMMANDS
int test1;
//    public void buttonControls() {
//        // plane
//        if (gamepad1.dpad_up || gamepad1.dpad_left || gamepad1.dpad_right || gamepad1.dpad_down) {
...
//TODO: Marcus/Oliver/Alejandro/Dominic:  research this method to learn more--STATE
int test3;
//    public void setTransferState(int state) {
//        switch (state) {
//            case TRANSFER_IDLE:
...
//TODO: Marcus/Oliver/Alejandro/Dominic:  research this method to learn more--RESET METHODS
int test5;
...
//    }
//
//    public void updateFrameTime() {                               //TODO: review this method--what is it for
